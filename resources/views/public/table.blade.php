...
@section('content')
    ...
    <div class="layui-fluid">
        ...
        <div class=" layui-form">
            <div class="layui-card layuiadmin-card-header-auto" id="search-container"
    ...
    <script type="text/javascript">
        ...
        layui.define(['form', 'element', 'table',], function () {
            let $ = layui.$
                , form = layui.form
                , table = layui.table;
            ...
            layui.init = function (options) {
                let table_default = {
                        ...
                        is_showBbreadcrumb: true,
                            ...
                            autoTableFixedHeight(this.elem[0]);
                    ...
                    table_add_default = {
                        ...
                        add_url: '{{asset('./edit')}}', //地址
                        add_submit_url: '{{asset('./edit')}}', //提交地址
                    ...
                    table_edit_default = {
                        ...
                        edit_url: '{{asset('./edit')}}', //地址
                        edit_submit_url: '{{asset('./edit')}}', //提交地址
                    ...
                    table_del_default = {
                        ...
                        del_submit_url: '{{asset('./ajaxDel')}}', //提交地址
